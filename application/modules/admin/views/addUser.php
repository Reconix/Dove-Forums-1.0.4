...
<ul>
    <li>
        ...
        <p><?php echo $this->lang->line('password'); ?><br><?php echo form_input($password); ?>&nbsp;&nbsp;<cite>Users Password. <strong>Note - This password has being generated automatically.</strong></cite></p>
